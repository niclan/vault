...
If you have a new version of Vault when you create a new KV store it will be a version 2 store and the actuall path to the data will have `/data/` after the KV store name:
...
Other variations in the paths may occur, please see the corresponding [secret engine documentation](https://www.vaultproject.io/docs/secrets)
